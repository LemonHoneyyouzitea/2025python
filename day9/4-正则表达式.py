...
def simple():
    ...
    简单匹配
    """
    res = re.match("wangdao", "wangdao.cn")
    if res:
        print(res.group())
...
def more_alp():
    ...
    ret = re.match("[A-Z][a-z]*", "AabcDdef")
    print(ret.group())
    print('-' * 50)
    names = ["name1", "_name", "2_name", "__name__"]
    for name in names:
        # [a - zA - Z_]：匹配任何一个字母（大小写）或者下划线（_）。
    ...
    print(ret.group())
    ret = re.match("[a-zA-Z0-9_]{8,20}", "1ad12f23ss*34455ff66")
    print(ret.group())
